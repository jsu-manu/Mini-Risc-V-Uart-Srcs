set_property -dict [list CONFIG.Coe_File {uartTest4.coe}] [get_ips mem_cell_0]
...
set_property -dict [list CONFIG.Coe_File {uartTest4.coe}] [get_ips mem_cell_1]
...
set_property -dict [list CONFIG.Coe_File {uartTest4.coe}] [get_ips mem_cell_2]
...
set_property -dict [list CONFIG.Coe_File {uartTest4.coe}] [get_ips mem_cell_3]
