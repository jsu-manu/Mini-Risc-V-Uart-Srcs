set_property -dict [list CONFIG.Coe_File {%0}] [get_ips imem_cell_0]
...
set_property -dict [list CONFIG.Coe_File {%1}] [get_ips imem_cell_1]
...
set_property -dict [list CONFIG.Coe_File {%2}] [get_ips imem_cell_2]
...
set_property -dict [list CONFIG.Coe_File {%3}] [get_ips imem_cell_3]
